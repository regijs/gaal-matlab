...
if m==6
   if nargin==4
      lineseg([a(1) 0 0],[a(2) 0 0],'c',0.5);
      lineseg([0 a(3) 0],[0 a(4) 0],'c',0.5);
      lineseg([0 0 a(5)],[0 0 a(6)],'c',0.5);
     texto(([0.95*a(2) 0 0.05*a(6)],nomex);
     texto(([0 0.95*a(4) 0.05*a(6)],nomey);
     texto(([0 0.05*a(4) a(6)],nomez);
   else
      axiss;
      plavec([a(1) 0 0],[a(2)-a(1) 0 0],'c',nomex,0.5);
      plavec([0 a(3) 0],[0 a(4)-a(3) 0],'c',nomey,0.5);
      plavec([0 0 a(5)],[0 0 a(6)-a(5)],'c',nomez,0.5);
  end
else
  axis square;
  if a(1)>=0
